  ...
  Future _onCreate(Database db, int version) async {
    ...
    await db.execute('''
      CREATE TABLE orders (
          ...
          status TEXT CHECK(status IN ('PENDIENTE','CONFIRMADO','ENTREGA_PARCIAL','ENTREGADO','CANCELADO')) DEFAULT 'PENDIENTE',
    ...
    await db.execute('''
      CREATE TABLE order_items (
          ...
          status TEXT CHECK(status IN ('ACTIVO','CANCELADO','ENTREGA_PARCIAL','ENTREGADO')) DEFAULT 'ACTIVO',
          unit_price REAL NOT NULL,
          surcharge REAL,
          total_price REAL NOT NULL,
          total_surcharge REAL,
